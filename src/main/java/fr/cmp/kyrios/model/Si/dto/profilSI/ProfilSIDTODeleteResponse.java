...
public class ProfilSIDTODeleteResponse {
    @Schema(description = "Message de confirmation de la suppression du profil SI", example = "Profil SI 'Developpeur fullstack' supprimé avec succès : 1 emploi a été détaché")
